...
const features = [
  {
    ...
    description: (
      <>
        系统支持部署在Linux、Windows、MacOS及国产操作系统在内的多种操作系统下面。同时支持电脑、Pad、手机等多终端操作。帮助企业节约布署成本，应对可能到来的各种挑战。
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        着力于员工全生命周期管理、目标是将人力资源部门转化为企业战略执行部门，除了解决业务自动化以外，强化<code>人才管理</code>及<code>分析与洞察</code>功能。满足高层管理者、业务人员、员工等不同视角人群的个性需求。
      </>
    ),
  },
  {
